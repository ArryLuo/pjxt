...
<div class="head">
  <div class="w_1002">
    <div class="logo"> <a href="/"><span class="zzjj_fz"></span> <img src="/r/cms/jmtob/default/images/logo_zx.png" /></a>
      <h1>江门职业技术学院</h1>
    </div>
  ...
  <div class="nav_banner_box"> 
    ...
    <div class="nav">
      <ul>
        ...
        <li><a href="/cms/column/186">政策资讯</a></li>
...
<div class="w_1002">
  ...
  <div class="arrange">
    ...
    <div class="arrange_list">
      <ul>
        [@cms_course page=0 rows=10 orderStatus='2' courseType='jiangm8afd07a72607895e0126078d40']
	    [#if course_tag.rows??]
        ...
        [@cms_course_comment page=0 rows=10 dateFormat='yyyy-MM-dd']
			...
			<li>
			      [#if a.uimage ??]
                              ...
                              [#else]
                              <img src="/r/cms/jmtob/default/images/grey_30x30/icon_tx.png" width="43" height="43" /><em></em>
                              [/#if]
