...
<div class="head">
  <div class="w_1002">
    <div class="logo"> <a href="/"><span class="zzjj_fz"></span> 
    	<img src="/res/v2/images/logo.png" /></a>
      <h1>广东学习网</h1>
    </div>
  ...
  <div class="nav_banner_box"> 
    ...
    <div class="nav">
      <ul>
        ...
        <li><a href="/cms/column/200">政策资讯</a></li>
    ...
    <!-- 登陆前显示-->
      ...
      <div class="inform">
        <h2>公告</h2>
        <ul>
           [@cms_content_list channelId='213' count='4' orderBy='updatetime desc'] 
			[#list tag_list as a]
  ...
  <div class="link_list">
    <ul>
        [@cms_content_list channelId='88' count='30'] 
             ...
             [/#list]
        [/@cms_content_list]
        <li><a href="http://www.1jymall.com/" title="1号教育" target="_blank">1号教育</a></li>
    </ul>
    <div class="c_l"></div>
  </div>
</div>
