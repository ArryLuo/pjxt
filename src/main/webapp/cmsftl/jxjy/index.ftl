...
<div class="head">
  <div class="w_1002">
    <div class="logo"> <a href="/"><span class="zzjj_fz"></span> <img src="/r/cms/jxjy/default/images/logo_zx.png" /></a>
      <h1>江门职业技术学院</h1>
    </div>
  ...
  <div class="nav_banner_box"> 
    ...
    <div class="nav">
      <ul>
        ...
        <li><a href="/cms/column/191">政策资讯</a></li>
    ...
    <!-- 登陆前显示-->
      ...
      <div class="inform">
        <h2>公告</h2>
        <ul>
           [@cms_content_list channelId='192' count='4' orderBy='updatetime desc'] 
			[#list tag_list as a]
...
<div class="w_1002">
  ...
  <div class="arrange">
    <h2> <span class="selected">专业排行榜</span> <span>选修排行榜</span> </h2>
    <div class="arrange_list">
      <ul>
        [@cms_course page=0 rows=10 orderStatus='2' courseType='yangj8afd07a72607895e0126078d40b']
	    [#if course_tag.rows??]
      ...
      <ul>
        [@cms_course page=0 rows=10 orderStatus='2' courseType='yangj8afd07a72607895e0126078e227']
	    [#if course_tag.rows??]
			[#list course_tag.rows as a]
				<li>[#if a_index==0]<i class="orange">[#elseif a_index>0&&a_index<3]<i class="yellow">[#elseif a_index>2]<i>[/#if]
					${a_index+1}</i><a href="/course/courseDetails/${a.id}" title="${a.cname}">[@text_cut s=a.cname len=14 append='...'/]</a>
  ...
  <div class="message">
    ...
    <ul>
      <li class="fl">
        ...
        <a href="#"> <img src="${res}/new_test/images/index/gd_99.png" />
        <h4>继续教育证书</h4>
      ...
      <li class="fr">
        ...
        <a href="#"> <img src="${res}/new_test/images/index/gd_96.png" />
...
<div class="w_1002 pd_20" style=" padding-bottom:10px;" > <a href="#"><img src="${res}/new_test/images/index/gd_112.jpg" /></a> </div>
<div class="w_1002">
        ...
        [@cms_course_comment page=0 rows=10 dateFormat='yyyy-MM-dd']
			...
			<li>
			      [#if a.uimage ??]
                              ...
                              [#else]
                              <img src="/r/cms/jxjy/default/images/grey_30x30/icon_tx.png" width="43" height="43" /><em></em>
                              [/#if]
