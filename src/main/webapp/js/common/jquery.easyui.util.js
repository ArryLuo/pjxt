...
if(_96.total<_96.pageSize+1){
_96.pageNumber=_96.pageNumber;
}
if(bb.num){
...
if(_96.total==_96.pageSize+1){
	_9a=_9a.replace(/{to}/,_96.pageSize*(_96.pageNumber));
}else{
	_9a=_9a.replace(/{to}/,_96.total);
}
...
if(bb.next){
	if(_96.pageSize+1 > _96.total){
		bb.next.linkbutton({disabled:true});
	}else{
		bb.next.linkbutton({disabled:false});
	}
...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50,100,200],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_a7,_a8){
...
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggable:false,resizable:true,shadow:false,modal:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _260(_261){
...
$("<a></a>").attr("href","javascript:void(0)").text(_283).addClass("btn btn-primary").css("margin-left",10).bind("click",eval(_282[_283])).appendTo(tb).linkbutton();
}
}
...
if((typeof(col.checkPermission)=='function'&&col.checkPermission(col))||(typeof(globalCheckPermission)=='function'&&globalCheckPermission(col))){
	col.hidden=true;
}
if(col.hidden){
td.hide();
