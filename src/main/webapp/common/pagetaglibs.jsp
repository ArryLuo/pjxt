...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/common/jquery.easyui.util.js?_1"></script>
...
<script>
	...
	function globalCheckPermission(col){            
		if((col.field=="platformSiteId"||col.field=="siteId" || col.field=="orgPlatformSite"|| col.field=="platformSiteIdText" || col.field=="platformid"||col.field=="platformName"||col.field=="platformSiteName")&&checkOnlySite){
