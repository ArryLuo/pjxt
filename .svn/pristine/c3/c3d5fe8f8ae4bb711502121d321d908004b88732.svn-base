  ...
  <div class="nav_banner_box"> 
    ...
    <div class="nav">
      <ul>
        ...
        <li><a href="/cms/column/b3a93e4d25c843dab2fedd1b1889d1ca">政策资讯</a></li>
    ...
    <!-- 登陆前显示-->
      ...
      <div class="inform">
        <h2>公告</h2>
        <ul>
           [@cms_content_list channelId='a81966f79fe8423ebfdb86e68687c70a' count='4' orderBy='updatetime desc'] 
			[#list tag_list as a]
...
<div class="w_1002 xxlc_box" >
  ...
  <ul  class="sy_jxjylc_box">
    ...
    <li> <img src="/res/v2/images/index/xxzk_bt_41.png" width="33" height="33" />
      <div class="bzmc"><span>第五步</span>学时证明</div>
    </li>
  ...
  <div class="message">
    ...
    <ul>
      <li class="fl">
        ...
        <a href="#"> <img src="/res/v2/images/index/gd_99.png" />
        <h4>继续教育证书</h4>
      ...
      <li class="fr">
        ...
        <a href="#"> <img src="/res/v2/images/index/gd_96.png" />
