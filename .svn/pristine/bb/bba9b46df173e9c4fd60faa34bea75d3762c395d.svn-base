  ...
  <div class="nav_banner_box"> 
    ...
    <div class="nav">
      <ul>
        ...
        <li><a href="/cms/column/9e11b94b0c8d43f5a0c2015e5638fa96">政策资讯</a></li>
    ...
    <!-- 登陆前显示-->
      ...
      <div class="inform">
        <h2>公告</h2>
        <ul>
           [@cms_content_list channelId='2250592133af49ba8441ef5cf6cd6eea' count='4' orderBy='updatetime desc'] 
			[#list tag_list as a]
...
<div class="w_1002">
  ...
  <div class="arrange">
    <h2> <span class="selected">必修排行榜</span> <span>选修排行榜</span> </h2>
    <div class="arrange_list">
      <ul>
        [@cms_course page=0 rows=10 orderStatus='2' courseType='6e439c2716e24bc3a176a269aa839fb7']
	    [#if course_tag.rows??]
      ...
      <ul>
        [@cms_course page=0 rows=10 orderStatus='2' courseType='3edf7e52e62547ee8c6499031d407c52']
	    [#if course_tag.rows??]
			[#list course_tag.rows as a]
				<li>[#if a_index==0]<i class="orange">[#elseif a_index>0&&a_index<3]<i class="yellow">[#elseif a_index>2]<i>[/#if]
					${a_index+1}</i><a href="/course/courseDetails/${a.id}" title="${a.cname}">[@text_cut s=a.cname len=14 append='...'/]</a>
...
<div class="w_1002">
  <div class="message">
    ...
    <ul>
      <li class="fl">
        <h3><span class="fl"><a class="c_y" href="/html/zcfg/">政策资讯</a></span><span class="fl">&nbsp;&nbsp;</span><span class="fr">2015.01.30</span></h3>
        <a href="/cms/content/477ac6d7613e445c8e990df5917d52c4"> <img src="/res/v2/images/index/gd_99.png" />
        <h4>企业培训网已经上线</h4>
        <p>企业培训网已经上线…</p>
        </a> </li>
      <li class="fr">
        <h3><span class="fl"><a class="c_y" href="/html/hyzx/">政策资讯</a></span><span class="fl">&nbsp;&nbsp;</span><span class="fr">2015.01.13</span></h3>
        <a href="/cms/content/298ac1d258e144adb8034261fcc38dfd"> <img src="/res/v2/images/index/gd_96.png" />
        <h4>广东阳江市局举办企业文化培训...</h4>
        <p>为进一步推进企业文化建设，提升员工素质,近日，广东阳江市局…</p>
        </a> </li>
      <li class="fl m_two">
        <h3><span class="fl"><a class="c_y" href="/html/zcfg/">政策资讯</a></span><span class="fl">&nbsp;/&nbsp;policy</span><span class="fr">2015.01.13</span></h3>
        <a href="/cms/content/be524ba98892466ba999e35208e8c78f">
        <h4>广东省中小企业局关于组织企业参加粤意中小企业高管培训合作...</h4>
        <p>各地级以上市中小企业行政主管部门，佛山市顺德区经济和科技…</p>
        </a> </li>
      <li class="fr m_two">
        <h3><span class="fl"><a class="c_y" href="/html/hyzx/">政策资讯</a></span><span class="fl">&nbsp;&nbsp;</span><span class="fr">2015.01.13</span></h3>
        <a href="/cms/content/9d138a9f15d14abba2c5046e37977784">
        <h4>互联网+”时代，企业培训该如何转型</h4>
        <p>随着“互联网+”成为时下最热门词汇，越来越多的企业、甚至于行业…</p>
        </a> </li>
      <li class="fl m_two">
        <h3><span class="fl"><a class="c_y" href="/html/zcfg/">政策资讯</a></span><span class="fl">&nbsp;&nbsp;</span><span class="fr">2015.01.13</span></h3>
        <a href="/cms/content/7d317903a72b4ca686cfe7223f7823d8">
        <h4>广东汕尾市局正式组建市级师资库提升内训水平...</h4>
        <p>为加强公司内部知识、经验、技能的相互交流与学习，形成…</p>
        </a> </li>
      <li class="fr m_two">
        <h3><span class="fl"><a class="c_y" href="/html/hyzx/">政策资讯</a></span><span class="fl">&nbsp;&nbsp;</span><span class="fr">2015.01.13</span></h3>
        <a href="/cms/content/c0e176a5664e4856979652c36effef11">
        <h4>广东重点企业对接资本市场系列培训会在东莞成功举办</h4>
        <p>为进一步提升资本市场服务实体经济的能力，并促进…</p>
        </a> </li>
    </ul>
  </div>
  <div class="teacher">
    ...
    <ul>
      	[@cms_content_list type="cms_index_teacher" count='3']
	       [#list tag_list as a] 
				<li>
...
<div class="w_1002 pd_20" style=" padding-bottom:10px;" > <a href="#"><img src="/res/v2/images/index/gd_112.jpg" /></a> </div>
<div class="w_1002">
        ...
        [@cms_course_comment page=0 rows=10 dateFormat='yyyy-MM-dd']
			...
			<li>
			      [#if a.uimage ??]
                              ...
                              [#else]
                              <img src="/r/cms/fskx/default/images/grey_30x30/icon_tx.png" width="43" height="43" /><em></em>
                              [/#if]
